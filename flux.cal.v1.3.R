...
#     Version: 1.4 add uncertainty analysis
...
#     10.gradient flux (not yet) 11. uncertainty analysis (pending)   
# ------------------------------------------------------------
...
#--- set the date for analysis 
 ...
 #  site.name = "MPI"
  ...
  ini.stamp = "2023-07-15 00:00:00"
  end.stamp = "2023-08-13 24:00:00"
  crop_id = "SXX"
#  ndays=60
#  n30=48*ndays  
